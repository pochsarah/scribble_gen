...
class S2MModel:
    def __init__(self, para,num_classes=1, logger=None, save_path=None, local_rank=0, world_size=1):
        self.para = para
        self.local_rank = local_rank

        self.S2M = nn.parallel.DistributedDataParallel(
            nn.SyncBatchNorm.convert_sync_batchnorm(
                deeplabv3plus_resnet50(num_classes=num_classes, output_stride=16, pretrained_backbone=False)
            ).cuda(),
